...
<head>
  <title>Turkey24 | Demokrasi</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
    ...
    <section><img style="
      ...
      margin-left: auto;
      margin-right: auto;"
      src="images/Turkey24.png" alt=""></section>
    <section id="navArea">
            ...
            <div class="single_post_content">
              <div class="single_post_content_left">
                <ul class="business_catgnav  wow fadeInDown">
                  <li>
                    <figure class="bsbig_fig"> <a href="pages/tarih_tekerrur.php" class="featured_img"> <img alt=""
                          src="images/haber_gorselleri/belediye.jpg"> <span class="overlay"></span> </a>
                      <figcaption> <a href="pages/tarih_tekerrur.php">Tarih Tekerrür</a>
                      </figcaption>
                    </figure>
                  </li>
                </ul>
              ...
              <div class="single_post_content_right">
                <ul class="business_catgnav  wow fadeInDown">
                  <li>
                    <figure class="bsbig_fig"> <a href="pages/altılı_masa_dagilma.php" class="featured_img"> <img alt=""
                          src="images/haber_gorselleri/altili-masa-6-gorusme-aa-1900614_2.jpg"> <span class="overlay"></span> </a>
                      <figcaption> <a href="pages/altılı_masa_dagilma.php">6'lı Masa Dağılıyor mu?</a>
                      </figcaption>
                    </figure>
                  </li>
                </ul>
            ...
            <div class="fashion_technology_area">
              <div class="fashion">
                <div class="single_post_content">
                  <ul class="business_catgnav wow fadeInDown">
                    <li>
                      <figure class="bsbig_fig"> <a href="pages/zafer_multeci.php" class="featured_img"> <img alt=""
                            src="images/haber_gorselleri/e2204da4-35e1-44a5-a3ad-108fe8401d05.jpg"> <span class="overlay"></span> </a>
                        <figcaption> <a href="pages/zafer_multeci.php">Zafer Partisi, Sadece Sığınmacılar Üzerinden Mi Hareket Ediyor?</a>
                        </figcaption>
                    </li>
                  </ul>
                ...
                <ul class="spost_nav">
                  <li>
                    <div class="media wow fadeInDown"> <a href="pages/tarih_tekerrur.php" class="media-left"> <img alt=""
                          src="images/haber_gorselleri/belediye.jpg"> </a>
