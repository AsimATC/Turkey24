              ...
              <div class="single_post_content">
                <div class="single_post_content_left">
                  <ul class="business_catgnav  wow fadeInDown">
                    <li>
                      <figure class="bsbig_fig"> <a href="pages/resesyon.php" class="featured_img"> <img alt=""
                            src="images/haber_gorselleri/istockphoto-1167797024-612x612.jpg"> <span class="overlay"></span> </a>
                        <figcaption> <a href="pages/resesyon.php">Resesyon Sırasında Dünya Borsalarının Durumu</a>
                        </figcaption>
                      </figure>
                    </li>
                  </ul>
